...
class WorkingHourController extends BaseController
{
    ...
    public function add(Request $request, Session $session) {
        ...
        $this->setStatusesParams(array($perso_id), 'workinghour',null, $GLOBALS['config']['PlanningHebdo-Validation-N2']);
    ...
    public function edit(Request $request, Session $session){
        ...
        $this->setStatusesParams(array($perso_id), 'workinghour', $id, $GLOBALS['config']['PlanningHebdo-Validation-N2']);
